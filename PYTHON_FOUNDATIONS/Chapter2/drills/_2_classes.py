...
class Calculator():
    def __init__(self):
        print("performs basic arithmatic")
...
class Apprentice():
    def __init__(self, name, cohort):
        self.name = name
        self.cohort = cohort
        print("represents an apprentice")
...
class Cohort():
    ...
    def __init__(self, name, start_date, end_date):
        ...
        print("represents a cohort")

    def calculate_duration(self):
        # result = (self.end_date - self.start_date).days
