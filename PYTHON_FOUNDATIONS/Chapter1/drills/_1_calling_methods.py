...
result1 = block_caps_a_string("hello world")
print(result1)
...
result2 = lower_case_a_string("HELLO WORLD")
print(result2)
...
result3 = length_of_a_string("hello")
print(result3)
...
result4 = reverse_a_string("hello")
print(result4)
...
result5 = swap_the_case_of_a_string("Hello World")
print(result5) 
...
result6 = is_integer_odd(1)
print(result6)

result7 = is_integer_odd(2)
print(result7)
...
result8 = is_integer_even(1)
print(result8)

result9 = is_integer_even(2)
print(result9)
...
result18 = float_is_positive(1.0)
print(result18)

result19 = float_is_positive(-1.0)
print(result19)
...
result20 = float_is_negative(1.0)
print(result20)

result21 = float_is_negative(-1.0)
print(result21)
...
result22 = boolean_to_string(True)
print(result22)
